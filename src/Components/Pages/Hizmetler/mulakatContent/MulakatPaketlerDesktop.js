...
import "./MulakatDesktop.css";

function MulakatPaketlerDesktop(props) {
      ...
      <div className="row">
        ...
        <div className="float-child-element">
          <div className="akademikContentD">
            ...
            <p className="paketInfo">
              ...
              eder. Genellikle online ortamda gerçekleştirilir. Başvurulan
              daldaki öğretim görevlileri ve bölüm heyeti görüşmeyi
              gerçekleştirir. Mülakat sırasında teknik sorular da sorulabilir.
            </p>
            <p className="madde">
          ...
          <div className="float-child-element">
            <div className="envanterContentD">
              ...
              <p className="paketInfo">
                ...
                yardımıyla cevaplanıp sisteme yüklendiği, kısa sorulardan oluşan
                ve bilgisayar ortamında gerçekleşen mülakat tipine sizi tam
                anlamıyla hazırlamak amacı ile kurgulanmıştır.
              </p>
              <p className="madde">
                <label className="tik">✓</label> Klasikleşmiş envanter (bireysel
                olarak gelen soruya video kaydederek cevap verdiğiniz)
                mülakatları simülasyonu
              </p>
              <p className="madde">
                <label className="tik">✓</label> 4 Deneme Sorusu
              </p>
              <p className="madde">
                <label className="tik">✓</label> Geri Bildirim + Sorulara en
                verimli cevabı verme eğitimi
              </p>
              <p className="madde">
        ...
        <div className="float-child-element">
          <div className="ikContentD">
            ...
            <p className="madde">
              <label className="tik">✓</label> 10 dakika yabancı dilde soru
              cevap (Tercihe bağlı)
            </p>
            <p className="madde">
...
export default MulakatPaketlerDesktop;
