...
// <div className="tos">
//   <h1 className="h1_">Eventival Privacy Policy Updates</h1>

//   <p className="p_"><strong>Effective: April 20, 2018</strong></p> 
//   <p>KİŞİSEL VERİLERİN KORUNMASI KANUNU UYARINCA AYDINLATMA METNİ<br/>
...
// bilgiyi, Kişisel Verilerin Korunması Kanunu (KVKK): 6698 sayılı Kişisel Verilerin Korunması Kanunu’nu,<br/>
// RESUMSHİNERS veya Veri Sorumlusu: Kişisel Verilerin işleme amaçlarını ve vasıtalarını belirleyen, veri kayıt<br/>
// sisteminin kurulmasından ve yönetilmesinden sorumlu olan tüzel kişiyi, ifade etmektedir.<br/>
// B.KİŞİSEL VERİLERİNİZİN İŞLENME AMACI VE İŞLENEN KİŞİSEL VERİLER<br/>
// …İsim-Soy isim<br/>
// …E-posta Adresi<br/>
// …Telefon numarası<br/>
...
// İşbu yukarıda belirtilen bilgiler özgeçmiş hazırlama ve niyet mektubu yazma hizmetleri kapsamında<br/>
// işlenecektir.<br/>
// C. Yasal Yükümlülükler ve Şirket içi Faaliyetler Amacıyla<br/>
// Mevzuata aykırı her türlü fiil, suç veya davranışa karşı sizin, RESUMESHİNERS ve çalışanlarının ve diğer<br/>
// üçüncü kişilerin güvenliğini sağlamak, mevzuattan kaynaklanan yükümlülüklerimizi yerine getirmek ve<br/>
// yetkili ve görevli özel veya kamu kurum ve kuruluşlarına karşı hukuki yükümlüklerimizi yerine getirmek,<br/>
// doğacak uyuşmazlıklarda mahkeme, icra dairesi, hakem heyeti gibi resmi kurum ve kuruluşlara karşı her<br/>
// türlü dava, cevap ve itiraz hakkının kullanılması, uyuşmazlıklara ilişkin görüşme ve anlaşma süreçlerinin<br/>
// yürütülmesi, tarafımızdan bilgi talep etmeniz veya yasal haklarınız kapsamında başvuruda bulunmanız<br/>
// halinde gerekli bilgilerin tarafınıza ulaştırılabilmesi, sözleşme ve mevzuata aykırı şekilde kullanımı<br/>
// engellemek, şüpheli işlemleri ve hukuka aykırı kullanımları tespit edebilmek, iptal işlemlerini<br/>
// gerçekleştirebilmek, iç denetim ve kontrol ile raporlama, test, geliştirme çalışmalarını yapabilmek ve<br/>
// müşteri deneyimini iyileştirmeye yönelik çalışma ve geliştirmeler, operasyonel süreçlere ilişkin stratejik<br/>
// planlama, analiz ve iş geliştirme çalışmaları yapılması kapsamında ad soyad, doğum tarihi, yasal süreçler<br/>
// nedeniyle aktarılması veya resmi mercilerce gönderilen belgelerde bulunması halinde imza ve T.C. Kimlik<br/>
// Numarası, cep telefonu numarası, e-posta adresi, adres, talep ve şikayetleriniz, faturalarınız, ödeme<br/>
// bilgileriniz, çağrı merkezi ses kayıtlarınız, Site üzerinden işlem yapmanız halinde log kayıtları, Kullanıcı ID,<br/>
// IP adresi, güvenlik kamerası kayıtları, ilgili hukuki işlem bilgileriniz ile uyuşmazlık süreçlerine ilişkin yazışma<br/>
// ve dosya bilgilerinizi,<br/>
// Çevrimiçi Ziyaretçi bakımından ise bilgi işlem güvenliğinin sağlanması ve kötü amaçlı kullanımların<br/>
// önlenmesi, faaliyetlerin mevzuata uygun yürütülmesi, yetkili ve görevli kamu kurum ve kuruluşlarına karşı<br/>
// diğer hukuki yükümlüklerimizi yerine getirmek amacıyla çerez kayıtları (IP adresi, gezinti bilgileri, kullanılan<br/>
...
// <br/>yükümlülüklerimizin yerine getirilmesi ile satış ve satış sonrası destek süreçlerine ilişkin olarak “Bir
// <br/>sözleşmenin kurulması veya ifasıyla doğrudan doğruya ilgili olması kaydıyla sözleşmenin taraflarına ait
// <br/>kişisel verilerin işlenmesinin gerekli olması”
// <br/>Pazarlama, segmentasyon ve analiz çalışmaları kapsamında kişisel veri işleme süreçlerine ve ticari iletişim
// <br/>faaliyetlerine ilişkin olarak vereceğiniz “açık rıza”,
// <br/>RESUMESHİNERS tarafından sunulan hizmetlerin, Site’nin ve Mobil Uygulamalarınınn kullanımı
// <br/>kapsamında şüpheli işlemlerin tespiti ve önlenmesi, işlem güvenliğinin sağlanması, operasyonel süreçlere
// <br/>(stratejik planlama, analiz ve iş geliştirme çalışmaları) ilişkin çalışmalar ve müşteri ilişkileri süreçlerimize
// <br/>ilişkin olarak “veri sorumlusunun meşru menfaatleri için veri işlenmesinin zorunlu olması”,
// <br/>Mevzuattan kaynaklanan yükümlülüklerimize ilişkin “hukuki yükümlülüğün yerine getirilmesi” ve
// <br/>“kanunlarda açıkça öngörülmesi”,
// <br/>Hukuki uyuşmazlık, soruşturma ve diğer adli/resmi süreçlere ilişkin olarak da “hakların tesisi, kullanılması
// <br/>veya korunması için veri işlemenin ve aktarmanın zorunlu olması”,
